// RUN: mlir-opt
// -load-pass-plugin=%mlir_lib_dir/goriacheva_k_replaces_memref.copy_operations_with_scf.for_loops_MLIR%shlibext
// --pass-pipeline="builtin.module(replace-memref-copy-with-loops)" %s |
// FileCheck %s
...
// MULTIPLE COPIES
// =======================
func.func @multiple_copies(%src: memref<4xi32>, %tmp: memref<4xi32>, %dst: memref<4xi32>) {
